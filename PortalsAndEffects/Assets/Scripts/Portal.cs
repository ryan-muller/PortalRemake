...
public class Portal : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (traveller)
        {
            ...
            if (Surface != null)
            {
                Physics.IgnoreCollision(Surface.GetComponent<Collider>(), traveller.GetComponent<Collider>(), true);
            }
    ...
    void OnTriggerExit(Collider other)
    {
        ...
        if (traveller && trackedTravellers.Contains(traveller))
        {
            if (Surface != null)
            {
                Physics.IgnoreCollision(Surface.GetComponent<Collider>(), traveller.GetComponent<Collider>(), false);
            }
            if (linkedPortal.Surface != null)
            {
                Physics.IgnoreCollision(linkedPortal.Surface.GetComponent<Collider>(), traveller.GetComponent<Collider>(), false);
            }
    ...
    public Camera PortalCam { get => portalCam; set => portalCam = value; }
